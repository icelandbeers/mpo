...
from DanteMusic import LOGGER, YouTube, app
from DanteMusic.misc import db
from DanteMusic.utils.database import (add_active_chat,
    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**Tidak Ditemukan Obrolan Suara Aktif**\n\nHarap pastikan obrolan suara grup diaktifkan. Jika sudah diaktifkan, harap akhiri dan mulai obrolan suara baru lagi dan jika masalah berlanjut, coba / mulai ulang"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**Asisten Sudah ada di Obrolan Suara**\n\nSistem telah mendeteksi bahwa asisten sudah ada di obrolan suara, masalah ini biasanya muncul saat Anda memainkan 2 kueri secara bersamaan.\n\nJika asisten tidak ada di obrolan suara, harap akhiri obrolan suara dan mulai obrolan suara baru lagi dan jika ada masalah berlanjut, coba / mulai ulang"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**Kesalahan Server Telegram**\n\nTelegram mengalami beberapa masalah server internal, Silakan coba mainkan lagi.\n\n Jika masalah ini terus terjadi, harap akhiri obrolan suara Anda dan mulai obrolan suara baru lagi."
            )
